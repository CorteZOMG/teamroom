...
export default function Login() {
  ...
  return (
    <div className="w-screen h-screen relative overflow-hidden">
      {/* Animated Background - Always present, but styled differently for mobile */}
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="w-full h-16 sm:h-20 md:h-24 bg-white rounded-[10px] mb-4 sm:mb-5 md:mb-6 relative shadow-sm hover:shadow-md transition-shadow duration-200">
              <input
                ...
                required
                className="w-full h-full bg-transparent border-none outline-none px-4 sm:px-5 md:px-6 py-2 text-primary text-xl sm:text-2xl md:text-3xl font-normal font-montserrat placeholder-gray-400 focus:placeholder-gray-300 transition-colors duration-200"
              />
            </div>
            ...
            <div className="w-full h-16 sm:h-20 md:h-24 bg-accent hover:bg-secondary rounded-[10px] mb-4 sm:mb-5 md:mb-6 relative shadow-sm hover:shadow-lg transition-all duration-100 active:scale-[0.98]">
              ...
              >
                <span className="text-white text-xl sm:text-2xl md:text-3xl font-normal font-montserrat">
